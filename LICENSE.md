...
- create modifications, mods, total conversions, derivative games, and
  modding or development tools based on the Original Materials;
- distribute the Original Materials and your modifications;
- distribute games and other projects incorporating the Original Materials;

provided that all such use complies with the restrictions in this license.

This license does not transfer ownership of the Original Materials or any
intellectual property rights in Unclaimed World to you.

2. NON-COMMERCIAL USE

Projects created using the Original Materials must be non-commercial unless
Refactored Games has given you separate written permission.

In particular, you may not:

- sell the game, a modified version of the game, a derivative game, or a
  mod containing the Original Materials;
- require payment for access to such a project;
...
A derivative game or project must not be named "Unclaimed World" by itself.

You must not use a name that implies that the project is an official sequel
or official release by Refactored Games, including names such as
"Unclaimed World 2", "Unclaimed World II", or similar names.

Names that clearly identify a project as a community or modified version are
permitted, including "Unclaimed World Moddable", "Unclaimed World Community",
and "Unclaimed World Deluxe".
...
You retain copyright in original material that you create yourself.

However, your rights in modifications or derivative works remain subject
to this license where they contain or are based on the Original Materials.

You may not impose additional restrictions that prevent other people from
exercising the rights granted by this license with respect to the Original
Materials.
...
materials included in the repository may be subject to separate licenses.
Those licenses continue to apply and are not superseded by this license.

8. DISTRIBUTION

When distributing a project containing Original Materials, you must include
a copy of this license and clearly identify the project as an unofficial
derivative or community project.

9. TERMINATION

This license automatically terminates if you materially violate its terms.

Upon termination, you must cease distribution of the Original Materials and
derivative works based on them, except that copies already lawfully obtained
by other users remain subject to this license unless those users themselves
violate its terms.
...
Nothing in this license is intended to limit any rights that cannot lawfully
...
Unclaimed World and associated names, logos, characters, artwork, and other
intellectual property remain the property of Refactored Games, except where
otherwise stated.
