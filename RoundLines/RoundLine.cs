...
namespace RoundLineCode
{
    ...
    struct RoundLineVertex : IVertexType
    {
        ...
        public readonly static VertexDeclaration VertexDeclaration = new VertexDeclaration
            (
                ...
                new VertexElement(28, VertexElementFormat.Byte4, VertexElementUsage.TextureCoordinate, 1) // works???
            );
    ...
    public class RoundLineManager
    {
        ...
        /// <summary>
        /// contains line point positions. These are used to translate the static buffer vertex positions to mark the plot points
        /// </summary>
        Vector4[] translationData;
       // float[] translationData;
        ...
        private void CreateRoundLineMesh()
        {
           ...
           // translationData = new float[numInstances * 4]; // Used in Draw()
            translationData = new Vector4[numInstances]; // Used in Draw()
        ...
        private void PopulateTranslationData(ref int iData, RoundLine roundLine)
        {
            ...
            /*
            translationData[iData++] = roundLine.P0.X; // 523f
            translationData[iData++] = roundLine.P0.Y; // 440f
            translationData[iData++] = roundLine.Rho;  // 0.155
            translationData[iData++] = roundLine.Theta; // 0f
           */
        }
    }
}
