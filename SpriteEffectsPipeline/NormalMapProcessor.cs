    ...
    public class NormalMapProcessor : ContentProcessor<TextureContent, TextureContent>
    {
     ...
     /*   public override TextureContent Process(TextureContent input,
                                               ...
                                               ContentProcessorContext context)
        {
            ...
            ExtendedSpriteSheetProcessor.GetDepthValues(bitmap, depthValues, doDebugLogging, context);
            ExtendedSpriteSheetProcessor.ConvertDepthToNormals(bitmap, depthValues, doDebugLogging, context);

            // Convert the result into NormalizedByte4 format.
          //  input.ConvertBitmapType(typeof(PixelBitmapContent<NormalizedByte4>)); // #MONOCHANGE - don't use Normalized anymore.
