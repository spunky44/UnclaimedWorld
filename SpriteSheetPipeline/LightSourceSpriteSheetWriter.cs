...
namespace SpriteSheetPipeline
{
    ...
    /// </summary>
    [ContentTypeWriter]
    public class LightSourceSpriteSheetWriter : ContentTypeWriter<LightSourceSpriteSheetContent>
    {
        /// <summary>
        /// Saves sprite sheet data into an XNB file.
        /// </summary>
        protected override void Write(ContentWriter output, LightSourceSpriteSheetContent value)
        {
            WriteSpriteSheet(output, value);
            
        }

        internal static void WriteSpriteSheet(ContentWriter output, LightSourceSpriteSheetContent value)
        {
            SpriteSheetWriter.WriteSpriteSheet(output, value);

            output.WriteObject(value.LightSourceTypeOffsets);           
        }
        ...
        {
        //    return typeof(SpriteSheetRuntime.SpriteSheetContentReader).AssemblyQualifiedName;
