...
namespace Steamworks {
	...
	public sealed class Callback<T> {
		...
		public void Register(DispatchDelegate func) {
            ...
            {
                NativeMethods.SteamAPI_RegisterCallback64(m_pCCallbackBase.AddrOfPinnedObject(), CallbackIdentities.GetCallbackIdentity(typeof(T)));
            }
            else
            {
		...
		public void Unregister() {
            ...
            if (Environment.Is64BitProcess)
            {
                NativeMethods.SteamAPI_UnregisterCallback64(m_pCCallbackBase.AddrOfPinnedObject());
            }
            else
            {
