...
// LPE: I made changes to this file!
...
namespace Steamworks {
	...
	public static class SteamAPI {
		...
		public static bool Init() {
            ...
            if (Environment.Is64BitProcess) // LPE added this
            {
                _initialized = NativeMethods.SteamAPI_InitSafe64();         
            }
            else
            {
		...
		public static void Shutdown() 
        {
            ...
            BranchOnBitnessVoid(NativeMethods.SteamAPI_Shutdown, NativeMethods.SteamAPI_Shutdown64);
		...
		public static void RunCallbacks() 
        {
            ...
            {
                NativeMethods.SteamAPI_RunCallbacks64();
            }
            else
            {
		...
		public static bool IsSteamRunning() {
            ...
            if (_initialized == false)
                return false; // LPE added this

			InteropHelp.TestIfPlatformSupported();

            return BranchOnBitness(NativeMethods.SteamAPI_IsSteamRunning, NativeMethods.SteamAPI_IsSteamRunning64).Invoke(); // LPE added this
			//return NativeMethods.SteamAPI_IsSteamRunning();
		}

        public static Func<bool> BranchOnBitness(Func<bool> bit32Function, Func<bool> bit64Function)
        {
            if (Environment.Is64BitProcess)
            {
                return bit64Function;
            }
            else
            {
                return bit32Function;
            }
        }
        public static IntPtr BranchOnBitnessPtr(Func<IntPtr> bit32Function, Func<IntPtr> bit64Function)
        {
            if (Environment.Is64BitProcess)
            {
                return bit64Function.Invoke();
            }
            else
            {
                return bit32Function.Invoke();
            }
        }
        public static void BranchOnBitnessVoid(Action bit32Function, Action bit64Function)
        {
            if (Environment.Is64BitProcess)
            {
                bit64Function.Invoke();
            }
            else
            {
                bit32Function.Invoke();
            }
        }
        ...
        /// LPE added this...
        /// </summary>
        public static void WriteMiniDump(Exception e, uint buildID)
        {
            InteropHelp.TestIfPlatformSupported();

            // object to IntPtr:
            GCHandle handle1 = GCHandle.Alloc(e);
            ...
            */
            ...
            NativeMethods.SteamAPI_WriteMiniDump((uint)e.Message.GetHashCode(),
                parameter, buildID);
        }
        ...
        /// LPE added this...
        /// </summary>
        public static void SetMiniDumpComment(string txt)
        {
            InteropHelp.TestIfPlatformSupported();
            NativeMethods. SteamAPI_SetMiniDumpComment(new Steamworks.InteropHelp.UTF8StringHandle(txt));
        }
