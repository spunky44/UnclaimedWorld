...
// LPE: I made changes to this file for Any CPU support!
...
namespace Steamworks {
	internal static class NativeMethods {
        ...
        internal const string NativeLibrary64bitName = "CSteamworks64"; // LPE added this, and renamed the 64 bit dll
#region steam_api.h

        [DllImport(NativeLibraryName, EntryPoint = "Shutdown", CallingConvention = CallingConvention.Cdecl)]
		public static extern void SteamAPI_Shutdown();

        [DllImport(NativeLibrary64bitName, EntryPoint = "Shutdown", CallingConvention = CallingConvention.Cdecl)]
        public static extern void SteamAPI_Shutdown64();
        ...
        [DllImport(NativeLibrary64bitName, EntryPoint = "IsSteamRunning", CallingConvention = CallingConvention.Cdecl)]
        [return: MarshalAs(UnmanagedType.I1)]
        public static extern bool SteamAPI_IsSteamRunning64();
        ...
        [DllImport(NativeLibrary64bitName, EntryPoint = "SteamClient_", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr SteamClient64();
        ...
        /// </summary>
        /// <returns></returns>
        [DllImport(NativeLibrary64bitName, EntryPoint = "InitSafe", CallingConvention = CallingConvention.Cdecl)]
        [return: MarshalAs(UnmanagedType.I1)]
        public static extern bool SteamAPI_InitSafe64();
        ...
        */
        ...
        [DllImport(NativeLibrary64bitName, EntryPoint = "RunCallbacks", CallingConvention = CallingConvention.Cdecl)]
        public static extern void SteamAPI_RunCallbacks64();
        ...
        */
        ...
        [DllImport(NativeLibrary64bitName, EntryPoint = "RegisterCallback", CallingConvention = CallingConvention.Cdecl)]
        public static extern void SteamAPI_RegisterCallback64(IntPtr pCallback, int iCallback);
        ...
        [DllImport(NativeLibrary64bitName, EntryPoint = "UnregisterCallback", CallingConvention = CallingConvention.Cdecl)]
        public static extern void SteamAPI_UnregisterCallback64(IntPtr pCallback);
...
#region SteamClient
        ...
        [DllImport(NativeLibraryName, EntryPoint = "ISteamClient_SetWarningMessageHook", CallingConvention = CallingConvention.Cdecl)]
		public static extern void ISteamClient_SetWarningMessageHook(SteamAPIWarningMessageHook_t pFunction);

        [DllImport(NativeLibrary64bitName, EntryPoint = "ISteamClient_SetWarningMessageHook", CallingConvention = CallingConvention.Cdecl)]
        public static extern void ISteamClient_SetWarningMessageHook64(SteamAPIWarningMessageHook_t pFunction);
...
#region SteamFriends
         ...
         */
        [DllImport(NativeLibraryName, EntryPoint = "ISteamFriends_GetPersonaName", CallingConvention = CallingConvention.Cdecl)]
		public static extern IntPtr ISteamFriends_GetPersonaName();

        [DllImport(NativeLibrary64bitName, EntryPoint = "ISteamFriends_GetPersonaName", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr ISteamFriends_GetPersonaName64(); // LPE
...
#region SteamUserStats
        ...
        [DllImport(NativeLibrary64bitName, EntryPoint = "ISteamUserStats_RequestCurrentStats", CallingConvention = CallingConvention.Cdecl)]
        [return: MarshalAs(UnmanagedType.I1)]
        public static extern bool ISteamUserStats_RequestCurrentStats64();
        ...
        [DllImport(NativeLibraryName, EntryPoint = "ISteamUserStats_GetAchievement", CallingConvention = CallingConvention.Cdecl)]
		[return: MarshalAs(UnmanagedType.I1)]
		public static extern bool ISteamUserStats_GetAchievement(InteropHelp.UTF8StringHandle pchName, out bool pbAchieved);

        [DllImport(NativeLibrary64bitName, EntryPoint = "ISteamUserStats_GetAchievement", CallingConvention = CallingConvention.Cdecl)]
        [return: MarshalAs(UnmanagedType.I1)]
        public static extern bool ISteamUserStats_GetAchievement64(InteropHelp.UTF8StringHandle pchName, out bool pbAchieved);
        ...
        [DllImport(NativeLibrary64bitName, EntryPoint = "ISteamUserStats_SetAchievement", CallingConvention = CallingConvention.Cdecl)]
        [return: MarshalAs(UnmanagedType.I1)]
        public static extern bool ISteamUserStats_SetAchievement64(InteropHelp.UTF8StringHandle pchName);
        ...
        [DllImport(NativeLibrary64bitName, EntryPoint = "ISteamUserStats_StoreStats", CallingConvention = CallingConvention.Cdecl)]
        [return: MarshalAs(UnmanagedType.I1)]
        public static extern bool ISteamUserStats_StoreStats64();
        

		[DllImport(NativeLibraryName, CallingConvention = CallingConvention.Cdecl)]
		public static extern int ISteamUserStats_GetAchievementIcon(InteropHelp.UTF8StringHandle pchName);

        [DllImport(NativeLibraryName, EntryPoint = "ISteamUserStats_GetAchievementDisplayAttribute", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(NativeLibrary64bitName, EntryPoint = "ISteamUserStats_GetAchievementDisplayAttribute", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr ISteamUserStats_GetAchievementDisplayAttribute64(InteropHelp.UTF8StringHandle pchName, InteropHelp.UTF8StringHandle pchKey);
...
#region SteamUtils
        ...
        [DllImport(NativeLibraryName, EntryPoint = "ISteamUtils_GetAppID", CallingConvention = CallingConvention.Cdecl)]
		public static extern uint ISteamUtils_GetAppID();

        [DllImport(NativeLibrary64bitName, EntryPoint = "ISteamUtils_GetAppID", CallingConvention = CallingConvention.Cdecl)]
        public static extern uint ISteamUtils_GetAppID64();
