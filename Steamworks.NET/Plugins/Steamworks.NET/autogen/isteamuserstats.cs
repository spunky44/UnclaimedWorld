...
namespace Steamworks {
	public static class SteamUserStats {
		...
		public static bool RequestCurrentStats() {
            ...
            {
                return NativeMethods.ISteamUserStats_RequestCurrentStats64();
            }
            else
            {
		...
		public static bool GetAchievement(string pchName, out bool pbAchieved) 
        {
			...
			using (var pchName2 = new InteropHelp.UTF8StringHandle(pchName)) 
            {
                if (Environment.Is64BitProcess)
                {
                    return NativeMethods.ISteamUserStats_GetAchievement64(pchName2, out pbAchieved);
                }
                else
                {
        ...
        public static bool SetAchievement(string pchName)
        {
            ...
            using (var pchName2 = new InteropHelp.UTF8StringHandle(pchName))
            {
                if (Environment.Is64BitProcess)
                {
                    return NativeMethods.ISteamUserStats_SetAchievement64(pchName2);
                }
                else
                {
                    return NativeMethods.ISteamUserStats_SetAchievement(pchName2);
		...
		public static bool StoreStats() {
            ...
            if (Environment.Is64BitProcess)
            {
                return NativeMethods.ISteamUserStats_StoreStats64();
            }
            else
            {
		...
		public static string GetAchievementDisplayAttribute(string pchName, string pchKey) {
			...
			using (var pchKey2 = new InteropHelp.UTF8StringHandle(pchKey)) 
            {
                if (Environment.Is64BitProcess)
                {
                    return InteropHelp.PtrToStringUTF8(NativeMethods.ISteamUserStats_GetAchievementDisplayAttribute64(pchName2, pchKey2));
                }
                else
                {
