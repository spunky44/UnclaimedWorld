...
namespace UWGame.ClientSide.Interface.Ledger
{
    ...
    public class ProductionSettings : SheetSettings<ProductionSettings.SortColumns> // ISnapshot
    {
        public enum SortColumns { Name, Produced, Consumed, Wasted, UsedInProduction, Disappeared, Productivity }
