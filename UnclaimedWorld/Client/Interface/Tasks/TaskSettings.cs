...
{
    /// <summary>
    /// should not contain the priority settings - those are Sim stuff!
    /// </summary>
    public class TaskSettings : ISnapshot
    {
        public enum SortColumns { Priority, Completion, TaskType }
        ...
        public TaskSettings()
        {
            ...
            {
                SortingSettings = new SortingSettings<SortColumns>(SortColumns.TaskType, SortingSettings<SortColumns>.DefaultSortOrder);
            }
        }
