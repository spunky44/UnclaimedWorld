    ...
    public class SteamManager 
    {
        ...
        public bool Initialize() // Awake()
        {
            ...
            */
            ...
            if (!isInitialized)
            {
                Console.WriteLine("[Steamworks.NET] SteamAPI_Init() failed. Refer to Valve's documentation or the comment above this line for more information.", this);

                string title = "[Steamworks.NET] SteamAPI_Init() failed.";
                string message = "Achievements will not be available."; 
