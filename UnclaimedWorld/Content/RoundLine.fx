...
technique Standard
{
	pass P0
	{
		...
		BlendOp = Add;
		vertexShader = compile vs_4_0_level_9_1 /*vs_1_1*/ MyVS();
		pixelShader = compile ps_4_0_level_9_1 /*ps_2_0*/ MyPSStandard();
	}
}
...
technique NoBlur
{
	pass P0
	{
		...
		BlendOp = Add;
		vertexShader = compile vs_4_0_level_9_1 /*vs_1_1*/ MyVS();
		pixelShader = compile ps_4_0_level_9_1 /*ps_2_0*/ MyPSNoBlur();
	}
}
...
technique AnimatedLinear
{
	pass P0
	{
		...
		BlendOp = Add;
		vertexShader = compile vs_4_0_level_9_1 /*vs_1_1*/ MyVS();
		pixelShader = compile ps_4_0_level_9_1 /*ps_2_0*/ MyPSAnimatedLinear();
	}
}
...
technique AnimatedRadial
{
	pass P0
	{
		...
		BlendOp = Add;
		vertexShader = compile vs_4_0_level_9_1 /*vs_1_1*/ MyVS();
		pixelShader = compile ps_4_0_level_9_1 /*ps_2_0*/ MyPSAnimatedRadial();
	}
}
...
technique Modern
{
	pass P0
	{
		...
		BlendOp = Add;
		vertexShader = compile vs_4_0_level_9_1 /*vs_1_1*/ MyVS();
		pixelShader = compile ps_4_0_level_9_1 /*ps_2_0*/ MyPSModern();
	}
}
...
technique Tubular
{
	pass P0
	{
		...
		BlendOp = Add;
		vertexShader = compile vs_4_0_level_9_1 /*vs_1_1*/ MyVS();
		pixelShader = compile ps_4_0_level_9_1 /*ps_2_0*/ MyPSTubular();
	}
}
...
technique Glow
{
	pass P0
	{
		...
		BlendOp = Add;
		vertexShader = compile vs_4_0_level_9_1 /*vs_1_1*/ MyVS();
		pixelShader = compile ps_4_0_level_9_1 /*ps_2_0*/ MyPSGlow();
	}
}
