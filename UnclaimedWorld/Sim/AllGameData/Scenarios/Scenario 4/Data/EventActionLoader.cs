...
namespace UWGame.SimSide.AllGameData.Scenarios.Scenario_4.Data
{
    public class EventActionLoader
    {
        public static List<EventActionType> Init()
        {
            ...
            list.Add(
                new SpawnSiteAction()
                {
                    ...
                    SiteData = new SiteData()
                    {
                        ...
                        Key = "playSite",    
                        Description = "This varied landscape was chosen by the settlers of Castor's Homestead and so it became our home.",
            ...
            #region spawnOtherSite1 - Destiny River Delta
            list.Add(
                new SpawnSiteAction()
                {
            ...
            list.Add(new SpawnEntityAction()
            {
                ...
                EntityData = new Maps.MapEditor.EntityData()
                {
                    ...
                    Person = new Maps.MapEditor.Person()
                    {
                        ...
                        LastName = "Hernes",
                        PersonalityType = "survivalTierPersonality", // "noComplainerPersonality", //Added a Leader effect instead 
            ...
            #endregion
            //additional people:
            /* other camp Location coords in case you need them for a big starting group.
             * Location = new Microsoft.Xna.Framework.Vector3(-118f, -6f, 0),
             * (-121f, 48f, 0) (-129f, 69f, 0), (-121f, 48f, 0), (-129f, 69f, 0), (-143f, 99f, 0), (-110f, 30f, 0), (-126f, 128f, 0), (-95f, 8f, 0), (15f, 2f, 0), (5, 47f, 0),
                  
                  
             */

            #region spawnPerson20
            list.Add(new SpawnEntityAction()
            {
                ...
                EntityData = new Maps.MapEditor.EntityData()
                {
                    Location = new Microsoft.Xna.Framework.Vector3(-121f, 48f, 0),
                    EntityKey = "entity:human",
                    MemberOf = new AllegianceAndExpedition()
                    {
                        AllegianceKey = "playerAllegiance",
                    ...
                    {
                        TraitTemplates = new StringChance[] { 
                                new StringChance() { Edge = 0.5f, String = "mechanicsSpecialist" }, 
                                new StringChance() { Edge = 1f, String = "smithingSpecialist" } },
                        #region CultureTemplates. Future, 100% equality
                        CultureTemplates = new StringChance[] {
                                //equal distribution:
            ...
            list.Add(ScenarioLoader.SpawnItemAtStartLocation("startStructureRadioHutImprovised", new Vector2(40f, -70f), "structure:radioHutImprovised", "playerAllegiance", null, delayForStructures));
            ...
            #region placeExpedition. GOODS prices. (Selling)
            list.Add(new CreateExpeditionAction()
              {
            ...
            list.Add(new SpawnAllegianceAction()
            {
                ...
                ExpeditionData = new ExpeditionData()
                {
                    ...
                    Location = new ValueNode()
                    {
                        Location = new Vector2(5345, 5500)
                    }
                },
                AllegianceData = new AllegianceData()
                {
            ...
            #region Twinkler north delete me
            list.Add(new SpawnAllegianceAction()
            {
                ...
                ExpeditionData = new ExpeditionData()
                {
                    ...
                    Location = new ValueNode()
                    {
                        Location = new Vector2(4468, 1100)
                    }
                },
                AllegianceData = new AllegianceData()
                {
            ...
            /*
            #region lesser whipjaw west (migration test) //moved to actionsetsloader
            list.Add(new EventActionType()
            {
                KeyName = "spawnLesserWhipjawExpeditionWest",
                    ...
                    ExpeditionData = new ExpeditionData()
                    {
                        Key = "lesserWhipjawAllegianceWest",
                    ...
                    AllegianceData = new AllegianceData()
                    {
                        ...
                        Name = "Lesser whipjaw Allegiance West",
                        Key = "lesserWhipjawAllegianceWest", // poor key name for expedition
            ...
            */
            ...
            #region Binal Rat Swamp  //mp removed for optimization jan 2016
            list.Add(new SpawnAllegianceAction()
            {
                KeyName = "spawnBinalRatExpeditionSwamp", //should change name
                ...
                ExpeditionData = new ExpeditionData()
                {
                    ...
                    Location = new ValueNode()
                    {
                        Location = new Vector2(2388, 5000)
                    }
                },
                AllegianceData = new AllegianceData()
                {
            ...
            #region Binal Rat Swamp2 //mp removed for optimization jan 2016
            list.Add(new SpawnAllegianceAction()
            {
                KeyName = "spawnBinalRatExpeditionSwamp2", //should change name
            ...
            #region Demon Tree #2 West //removed for optimization jan 2016
            list.Add(new SpawnAllegianceAction()
            {
            ...
            #region sawmp Demon Tree #1 south // autospawns. but removed for optimization jan 2016
            list.Add(new SpawnAllegianceAction()
            {
            ...
            #region sawmp Demon Tree #2 north
            list.Add(new SpawnAllegianceAction()
            {
            ...
            list.Add(new SpawnAllegianceAction()
            {
                ...
                ExpeditionData = new ExpeditionData()
                {
                    ...
                    Location = new ValueNode()
                        {
                            Location = new Vector2(2000, 4800)
                        }
                },
                AllegianceData = new AllegianceData()
                {
            ...
            list.Add(new SpawnAllegianceAction()
            {
                ...
                ExpeditionData = new ExpeditionData()
                {
                    ...
                    Location = new ValueNode()
                    {
                        Location = new Vector2(5328, 912)//(4972, 3572)
                    }
                },
                AllegianceData = new AllegianceData()
                {
            ...
            #region Thunder Chicken #1 //mp removed for optim. jan 2016
            list.Add(new SpawnAllegianceAction()
            {
                ...
                ExpeditionData = new ExpeditionData()
                {
                    ...
                    Location = new ValueNode()
                        {
                            Location = new Vector2(2736, 1776)
                        }
                },
                AllegianceData = new AllegianceData()
                {
            ...
            #endregion
            #region Thunder Chicken #3 -SouthEast corner  //mp autospawns with thunderchickens. but  removed for optimization jan 2016
            list.Add(new SpawnAllegianceAction()
            {
                ...
                ExpeditionData = new ExpeditionData()
                {
                    ...
                    Location = new ValueNode()
                    {
                        Location = new Vector2(5328, 5328)
                    }
                },
                AllegianceData = new AllegianceData()
                {
            ...
            list.Add(new SpawnAllegianceAction()
            {
                ...
                ExpeditionData = new ExpeditionData()
                {
                    ...
                    Location = new ValueNode()
                    {
                        Location = new Vector2(1584, 1296)//(2228, 1008)
                    }
                },
                AllegianceData = new AllegianceData()
                {
                    ForageAndHuntingRadius = 1500, //the radius was 600 when we had 5 nests
            ...
            #endregion
            #region leafcutter expedition #2 //mp removed for optimization jan 2016
            ...
            list.Add(new SpawnAllegianceAction()
            {
                ...
                ExpeditionData = new ExpeditionData()
                {
                    ...
                    Location = new ValueNode()
                    {
                        Location = new Vector2(2496, 240)//(1536, 1536)
                    }
                },
                AllegianceData = new AllegianceData()
                {
            ...
            list.Add(new SpawnAllegianceAction()
            {
                ...
                ExpeditionData = new ExpeditionData()
                {
                    ...
                    Location = new ValueNode()
                    {
                        Location = new Vector2(3600, 1248)//(2496, 288)
                    }
                },
                AllegianceData = new AllegianceData()
                {
            ...
            #endregion
            #region leafcutter expedition #4
            ...
            list.Add(new SpawnAllegianceAction()
            {
                ...
                ExpeditionData = new ExpeditionData()
                {
                    ...
                    Location = new ValueNode()
                    {
                        Location = new Vector2(2784, 1632)
                    }
                },
                AllegianceData = new AllegianceData()
                {
            ...
            #endregion
            #region leafcutter expedition #5
            ...
            /*      list.Add(new EventActionType() //mp not used. the field quadite nests don't respawn.
            {
            ...
            list.Add(new SetPropertyAction()
            {
                ...
                Value = new ValueNode() { Int = 2400 },// we don't really want the focus to be on combat; which is the reason to the high spawn delay
            ...
            list.Add(new SetPropertyAction()
            {
                ...
                Value = new ValueNode() { Int = 2400 },// we don't really want the focus to be on combat; which is the reason for the high spawn delay
            ...
            list.Add(new SpawnEntityAction() //south east
            {
                ...
                EntityData = new EntityData()
                {
                    EntityKey = "terrain:pierSpot",
                    Name = "Pier spot",
                    Location = new Vector3(4340f, 5192f, 0)
                },
            ...
            list.Add(new SpawnEntityAction()
            {
                ...
                EntityData = new EntityData()
                {
                    ...
                    Location = new Vector3(3504f, 3440f, 0)
                },
            ...
            list.Add(new SpawnEntityAction()
            {
                ...
                EntityData = new EntityData()
                {
                    EntityKey = "terrain:fishTrapSpotShore",
                    Name = "Fish trap spot Freshwater",
                    Location = new Vector3(3576f, 3128f, 0) //was (3580f, 3130f, 0) but moved it. close to being blocked.
                },
            ...
            list.Add(new SpawnEntityAction()
            {
                KeyName = "startBogOreDeposit3", //only for large map version
                DelayInSeconds = 1,
                ...
                EntityData = new EntityData()
                {
                    EntityKey = "terrain:bogOreDeposit",
                    Name = "Bog ore deposit",
                    Location = new Vector3(5616f, 5492f, 0) // south east corner 
                },
            ...
            #endregion
            #region peat deposit //only for large map version
            list.Add(new SpawnEntityAction()
            {
                KeyName = "startPeatDeposit4", //large map. south east corner
                DelayInSeconds = 1,
                ...
                EntityData = new EntityData()
                {
                    EntityKey = "terrain:peatDeposit",
                    Name = "Peat deposit",
                    Location = new Vector3(5361f, 5636f, 0) //
                },
            ...
            #endregion
            #region salt deposit //only for large map version
            list.Add(new SpawnEntityAction()
            {
                ...
                EntityData = new EntityData()
                {
                    EntityKey = "terrain:saltDeposit",
                    Name = "Salt deposit",
                    Location = new Vector3(4992f, 3648f, 0) //desert to the east
                },
            ...
            #endregion
            #region clay deposit //only for large map version
            list.Add(new SpawnEntityAction()
            {
                ...
                EntityData = new EntityData()
                {
                    EntityKey = "terrain:clayDeposit",
                    Name = "Clay deposit",
                    Location = new Vector3(3600f, 4800f, 0) // south east
                },
