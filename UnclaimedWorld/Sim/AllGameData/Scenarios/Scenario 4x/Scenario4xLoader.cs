...
namespace UWGame.SimSide.AllGameData.Scenarios.Scenario_4x // I chose a generic name so scenario name changes don't affect us so much...
{
    /// <summary>
    /// 
    ...
    /// </summary>
    public class Scenario4xLoader : ScenarioLoader // I chose a generic name so scenario name changes don't affect us so much...
    {
        ...
        {
            get { return "Fields of Tau Ceti - Cudgel Hills (M)"; }//was: (Medium)
        }
        ...
        {
            DataLoader dataLoader = new Scenario4xDataLoader();
...
#region Spawn otherSite2 (random)                
                  ...
                  #region pier spots
                        "startPierSpot1",//emerald river, fishers
                        "startPierSpot3", //north east
                  #endregion
                                   ...
                                   new Option()
                                    {
                                      ...
                                      ConditionalEvents = new[]{"introDialogueFishing", "introDialogueScreen"}, //INTRO DIALOGUE AND SCREEN
                                       ActionKeys = new[]
                                       {  //STARTING LOCATION:
                                           "setStartingLocationRiverBank", "exploreShroudRiverBank", //todo coords?
                        ...
                        { 
                            new Option()
                            {
                                ...
                                { 
                                    ...
                                    "startFarmSpotSmall1", "startFarmSpotSmall2",  "startFarmSpotSmall4", "startFarmSpotSmall5",  "startFarmSpotSmall7", "startFarmSpotSmall8", "startFarmSpotSmall9",  "startFarmSpotSmall11", "startFarmSpotSmall12", "startFarmSpotSmall13", "startFarmSpotSmall14",
                                    "startFarmSpotLarge1", "startFarmSpotLarge2",  "startFarmSpotLarge4", 

                                    "startFishTrapCreek2", "startFishTrapCreek5", "startFishTrapCreek6", "startFishTrapCreek7",                                  
                                    
                                    "startFishTrapShore1", "startFishTrapShore2", "startFishTrapShore3", "startFishTrapShore4",// terrain changed "startFishTrapShore5", 
                                    "startFishTrapShore6", "startFishTrapShore7", "startFishTrapShore8",  "startFishTrapShore17", "startFishTrapShore18", "startFishTrapShore19", 
