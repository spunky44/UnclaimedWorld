...
new ActionSetType("1df356eyurtyhrtysurykykyk7w756a91")
                    ...
                    new TalkAction("fecd467867ejuidtjdtsyhjuyty0878") { DelayInSeconds = 3, 
                        ...
                        ActionByAgent = ActionByAgent.RandomInAllegiance,
                        DefaultText = "They'll be heading towards the swamp. Let's catch some!" },//different on this map. not:  Emerald river
                       }
                        },
#endregion
                        ...
                        {   
                            new SpawnAllegianceAction()
                            {
                                ...
                                KeyName = "spawnLesserWhipjawExpeditionWest",
                                    ...
                                    ExpeditionData = new ExpeditionData()
                                    {
                                        ...
                                        {
                                            Location = new Vector2(3168, 3744)
                                        }
                                    },
                           ...
                           EntityData = new EntityData()
                                { EntityKey = "entity:lesserWhipjaw", MemberOf = new AllegianceAndExpedition() { AllegianceKey = "lesserWhipjawAllegianceWest" },
                                  Location = new Vector3(480, 28, 0), Bulk = 0.3f, BioEntity = new Maps.MapEditor.BiologicalEntity()
                                { AgeGroup = AIAgeGroup.Adult, } }, },
                            new SpawnEntityAction("6f04678674864786476reuijte7jdtyj8950f1") { DelayInSeconds = 0.6,
                           EntityData = new EntityData()
                                { EntityKey = "entity:lesserWhipjaw", MemberOf = new AllegianceAndExpedition() { AllegianceKey = "lesserWhipjawAllegianceWest" },
                                  Location = new Vector3(480, 48, 0), Bulk = 0.3f, BioEntity = new Maps.MapEditor.BiologicalEntity()
                                { AgeGroup = AIAgeGroup.Adult,  } }, },
                            new SpawnEntityAction("04961fdtyjdt7tjddgtde56jueac51bd4") { DelayInSeconds = 0.2,
                           EntityData = new EntityData()
                                { EntityKey = "entity:lesserWhipjaw",  MemberOf = new AllegianceAndExpedition() { AllegianceKey = "lesserWhipjawAllegianceWest" },
                                  Location = new Vector3(480, 96, 0), Bulk = 0.3f, BioEntity = new Maps.MapEditor.BiologicalEntity()
                                { AgeGroup = AIAgeGroup.Adult, } }, },
                            new SpawnEntityAction("ea7srtdtyjt76u6rudtyjudtub61b2c") { DelayInSeconds = 1,
                           EntityData = new EntityData()
                                { EntityKey = "entity:lesserWhipjaw", MemberOf = new AllegianceAndExpedition() { AllegianceKey = "lesserWhipjawAllegianceWest" },
                                  Location = new Vector3(480, 144, 0), Bulk = 0.3f, BioEntity = new Maps.MapEditor.BiologicalEntity()
                                { AgeGroup = AIAgeGroup.Adult,  } }, },                   
 
                            new SpawnEntityAction("043q456t34q56tae5456jueac51bd4") { DelayInSeconds = 6.4,
                           EntityData = new EntityData()
                                { EntityKey = "entity:lesserWhipjaw",  MemberOf = new AllegianceAndExpedition() { AllegianceKey = "lesserWhipjawAllegianceWest" },
                                  Location = new Vector3(480, 192, 0), Bulk = 0.3f, BioEntity = new Maps.MapEditor.BiologicalEntity()
                                { AgeGroup = AIAgeGroup.Adult, } }, },
////////////////////////////////////////
                           ...
                           EntityData = new EntityData()
                                { EntityKey = "entity:lesserWhipjaw", MemberOf = new AllegianceAndExpedition() { AllegianceKey = "lesserWhipjawAllegianceWest" },
                                  Location = new Vector3(432, 144, 0), Bulk = 0.3f, BioEntity = new Maps.MapEditor.BiologicalEntity()
                                { AgeGroup = AIAgeGroup.Adult,  } }, },
//////////////////////////////////
//////////////////////////////:
                           ...
                           EntityData = new EntityData()
                                { EntityKey = "entity:lesserWhipjaw",  MemberOf = new AllegianceAndExpedition() { AllegianceKey = "lesserWhipjawAllegianceWest" },
                                  Location = new Vector3(432, 96, 0), Bulk = 0.3f, BioEntity = new Maps.MapEditor.BiologicalEntity()
                                { AgeGroup = AIAgeGroup.Adult, } }, },
                            new SpawnEntityAction("easr45yrs5t6tdfydstyasetyrsttub61b2c") { DelayInSeconds = 3.5,
                           EntityData = new EntityData()
                                { EntityKey = "entity:lesserWhipjaw", MemberOf = new AllegianceAndExpedition() { AllegianceKey = "lesserWhipjawAllegianceWest" },
                                  Location = new Vector3(528, 48, 0), Bulk = 0.3f, BioEntity = new Maps.MapEditor.BiologicalEntity()
                                { AgeGroup = AIAgeGroup.Adult,  } }, },                   
                            new SpawnEntityAction("4dwrsrty64y765674w5767455464yw213") { DelayInSeconds = 2.8,
                           EntityData = new EntityData()
                                { EntityKey = "entity:lesserWhipjaw", MemberOf = new AllegianceAndExpedition() { AllegianceKey = "lesserWhipjawAllegianceWest" },
                                  Location = new Vector3(432, 55, 0), Bulk = 0.3f, BioEntity = new Maps.MapEditor.BiologicalEntity()
                                { AgeGroup = AIAgeGroup.Adult,  } }, },
...
#region      //North edge, center:
                           ...
                           EntityData = new EntityData()
                                { EntityKey = "entity:bajingan", Name = "Bajingan1", MemberOf = new AllegianceAndExpedition() { AllegianceKey = "bajinganAllegianceWest" },
                                  Location = new Vector3(2064, 48, 0), Bulk = 0.3f, BioEntity = new Maps.MapEditor.BiologicalEntity()
                                { AgeGroup = AIAgeGroup.Adult, }  }},
                           ...
                           EntityData = new EntityData()
                                { EntityKey = "entity:bajingan", Name = "Bajingan2", MemberOf = new AllegianceAndExpedition() { AllegianceKey = "bajinganAllegianceWest" },
                                  Location = new Vector3(2044, 48, 0), Bulk = 0.3f, BioEntity = new Maps.MapEditor.BiologicalEntity()
                                { AgeGroup = AIAgeGroup.Adult,  }  }},
                            new SpawnEntityAction("04961f4c-9srtyues5e6rue56jueac51bd4") { DelayInSeconds = 5.2,
                           EntityData = new EntityData()
                                { EntityKey = "entity:bajingan", Name = "Bajingan1", MemberOf = new AllegianceAndExpedition() { AllegianceKey = "bajinganAllegianceWest" },
                                  Location = new Vector3(2084, 48, 0), Bulk = 0.3f, BioEntity = new Maps.MapEditor.BiologicalEntity()
                                { AgeGroup = AIAgeGroup.Adult, }  }},
                            new SpawnEntityAction("ea7srtyuh65e78uerthjryuyryub61b2c") { DelayInSeconds = 6,
                           EntityData = new EntityData()
                                { EntityKey = "entity:bajingan", Name = "Bajingan2", MemberOf = new AllegianceAndExpedition() { AllegianceKey = "bajinganAllegianceWest" },
                                  Location = new Vector3(2104, 48, 0), Bulk = 0.3f, BioEntity = new Maps.MapEditor.BiologicalEntity()
                                { AgeGroup = AIAgeGroup.Adult,  }  }},                   
...
#region            ////////////north east :
                           ...
                           EntityData = new EntityData()
                                { EntityKey = "entity:bajingan", Name = "Bajingan1", MemberOf = new AllegianceAndExpedition() { AllegianceKey = "bajinganAllegianceWest" },
                                  Location = new Vector3(2016, 96, 0), Bulk = 0.3f, BioEntity = new Maps.MapEditor.BiologicalEntity()
                                { AgeGroup = AIAgeGroup.Adult, }  }},
                            new SpawnEntityAction("sfgjhnxdgtrydtjufghx48950f1") { DelayInSeconds = 0.6,
                           EntityData = new EntityData()
                                { EntityKey = "entity:bajingan", Name = "Bajingan2", MemberOf = new AllegianceAndExpedition() { AllegianceKey = "bajinganAllegianceWest" },
                                  Location = new Vector3(2064, 96, 0), Bulk = 0.3f, BioEntity = new Maps.MapEditor.BiologicalEntity()
                                { AgeGroup = AIAgeGroup.Adult,  }  }},
                            new SpawnEntityAction("dhjxghnjxrsyhjugfshsfgheac51bd4") { DelayInSeconds = 0.2,
                           EntityData = new EntityData()
                                { EntityKey = "entity:bajingan", Name = "Bajingan1", MemberOf = new AllegianceAndExpedition() { AllegianceKey = "bajinganAllegianceWest" },
                                  Location = new Vector3(2112, 96, 0), Bulk = 0.3f, BioEntity = new Maps.MapEditor.BiologicalEntity()
                                { AgeGroup = AIAgeGroup.Adult, }  }},
                ...
                SetsOfActions = new[]
                {
                    ...
                    new ActionSetType("d92a70sada252afa3f3ff51d-afdsaf32523-47d-9b02-7cccbfbe39f5")
                    {
                        ...
                        Actions = new EventActionType[]
                        {
                            ...
                            {
                                DelayInSeconds = nestSpawnInterval,                                   
                                EntityDataKey = new ValueNode(){ String = "fieldQuaditeNest3" }                                                           
                            }                           
                        }
                    },
                    #endregion 
