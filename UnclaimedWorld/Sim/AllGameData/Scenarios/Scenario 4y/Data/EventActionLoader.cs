...
namespace UWGame.SimSide.AllGameData.Scenarios.Scenario_4y.Data
{
    public class EventActionLoader
    {
        public static List<EventActionType> Init()
        {
            ...
            list.Add(
                new SpawnSiteAction()
                {
                 ...
                 //   SiteDataKey = "playSite",// not linked to sitedataloader
                    ...
                    {
                        Name = "Alluvial Plain", //Cudgel Hills  //has to be generic enough that it covers all the landscape types on map
                        KeyName = "playSite",
                        Description = "This varied landscape was chosen as a home by us, the founders of Castor's Homestead.",
                        Coords = new Overland.Locations.GeodeticCoordinate(9.3d, 71.9d), //make sure they can travel by boat in straight line to and from. //Latitude = , Longitude =  },
                        IsPlaySite = true,
                        ShowLabel = true,
                        ShowTallPin = true,
                        SiteMarkerOrder = 10
            ...
            list.Add(
               new SpawnSiteAction()
               {
                   ...
                   SiteData = new SiteData()
                   {
                       ...
                       Coords = new Overland.Locations.GeodeticCoordinate(9.212d, 71.8d),//9.22d, 71.8d
                       IsPlaySite = false,
                       ShowLabel = false,
                       ShowTallPin = false, //
                     //  SiteMarkerOrder = 10,
            ...
            list.Add(Scenarios.ScenarioLoader.SpawnItemAtStartLocation("startShingles", new Vector2(testDistanceX, testDistanceY), "item:spoakShingles", "playerAllegiance", null, delayForItemsAndAgents));
            list.Add(Scenarios.ScenarioLoader.SpawnItemAtStartLocation("startMudbricks", new Vector2(testDistanceX, testDistanceY), "item:solidMudBrick", "playerAllegiance", null, delayForItemsAndAgents));
            list.Add(Scenarios.ScenarioLoader.SpawnItemAtStartLocation("startSpoakTrimmed", new Vector2(testDistanceX, testDistanceY), "item:spoakBranchesTrimmed", "playerAllegiance", null, delayForItemsAndAgents));
           
            list.Add(Scenarios.ScenarioLoader.SpawnItemAtStartLocation("startMetalLatheComponents", new Vector2(testDistanceX, testDistanceY), "item:metalLatheComponents", "playerAllegiance", null, delayForItemsAndAgents));
            list.Add(Scenarios.ScenarioLoader.SpawnItemAtStartLocation("startHumanPowerUnit", new Vector2(testDistanceX, testDistanceY), "item:humanPowerUnit", "playerAllegiance", null, delayForItemsAndAgents));
            list.Add(Scenarios.ScenarioLoader.SpawnItemAtStartLocation("startBlisterSteel", new Vector2(testDistanceX, testDistanceY), "item:blisterSteel", "playerAllegiance", null, delayForItemsAndAgents));
            list.Add(Scenarios.ScenarioLoader.SpawnItemAtStartLocation("startWroughtIron", new Vector2(testDistanceX, testDistanceY), "item:wroughtIron", "playerAllegiance", null, delayForItemsAndAgents));
            list.Add(Scenarios.ScenarioLoader.SpawnItemAtStartLocation("startChickenTannedHide", new Vector2(testDistanceX, testDistanceY), "item:thunderChickenTannedHide", "playerAllegiance", null, delayForItemsAndAgents));

            list.Add(Scenarios.ScenarioLoader.SpawnItemAtStartLocation("startExtrusionMachine", new Vector2(testDistanceX, testDistanceY), "item:extrusionMachineComponents", "playerAllegiance", null, delayForItemsAndAgents));
            list.Add(Scenarios.ScenarioLoader.SpawnItemAtStartLocation("startLoomComponents", new Vector2(testDistanceX, testDistanceY), "item:loomComponents", "playerAllegiance", null, delayForItemsAndAgents));
            
            ////////////////   


            list.Add(Scenarios.ScenarioLoader.SpawnItemAtStartLocation("startScrapMetal", new Vector2(testDistanceX, testDistanceY), "item:scrapMetal", "playerAllegiance", null, delayForItemsAndAgents));
            ...
            list.Add(Scenarios.ScenarioLoader.SpawnItemAtStartLocation("startshadeleafCanesTest", new Vector2(testDistanceX, testDistanceY), "item:shadeleafCanes", "playerAllegiance", null, delayForItemsAndAgents, amount: 20));
            list.Add(Scenarios.ScenarioLoader.SpawnItemAtStartLocation("startDiamondGlass", new Vector2(testDistanceX, testDistanceY), "item:diamondGlass", "playerAllegiance", null, delayForItemsAndAgents, amount: 10));
         ...
         #region food
            ...
            #endregion
            #region seeds
            list.Add(Scenarios.ScenarioLoader.SpawnItemAtStartLocation("startCrystalTest", new Vector2(foodDistanceX, foodDistanceY), "item:crystalBerries", "playerAllegiance", null, delayForItemsAndAgents));
            ...
            list.Add(Scenarios.ScenarioLoader.SpawnItemAtStartLocation("startCottonTest", new Vector2(foodDistanceX, foodDistanceY), "item:cotton", "playerAllegiance", null, delayForItemsAndAgents));
            #endregion
            #region weapons
            ...
            list.Add(Scenarios.ScenarioLoader.SpawnItemAtStartLocation("startSentry", new Vector2(weaponsDistanceX, weaponsDistanceY), "item:sentry", "playerAllegiance", null, delayForItemsAndAgents));
            list.Add(Scenarios.ScenarioLoader.SpawnItemAtStartLocation("startSentryAmmo", new Vector2(weaponsDistanceX, weaponsDistanceY), "item:sentryGunAmmo", "playerAllegiance", null, delayForItemsAndAgents));
            ...
            #endregion
                #region Tools
            list.Add(Scenarios.ScenarioLoader.SpawnItemAtStartLocation("startMachete", new Vector2(toolsDistanceX, toolsDistanceY), "item:advancedMachete", "playerAllegiance", null, delayForItemsAndAgents));
            list.Add(Scenarios.ScenarioLoader.SpawnItemAtStartLocation("startSnips", new Vector2(toolsDistanceX, toolsDistanceY), "item:advancedSnips", "playerAllegiance", null, delayForItemsAndAgents));
            list.Add(Scenarios.ScenarioLoader.SpawnItemAtStartLocation("startString", new Vector2(toolsDistanceX, toolsDistanceY), "item:advancedString", "playerAllegiance", null, delayForItemsAndAgents));
            ...
            list.Add(Scenarios.ScenarioLoader.SpawnItemAtStartLocation("startKnife", new Vector2(toolsDistanceX, toolsDistanceY), "item:steelKnife", "playerAllegiance", null, delayForItemsAndAgents));

            list.Add(Scenarios.ScenarioLoader.SpawnItemAtStartLocation("startCookingPot", new Vector2(toolsDistanceX, toolsDistanceY), "item:advancedCookingPot", "playerAllegiance", null, delayForItemsAndAgents));
            ...
            list.Add(Scenarios.ScenarioLoader.SpawnItemAtStartLocation("startCottonString", new Vector2(toolsDistanceX, toolsDistanceY), "item:cottonString", "playerAllegiance", null, delayForItemsAndAgents));
            list.Add(Scenarios.ScenarioLoader.SpawnItemAtStartLocation("startFishingNet", new Vector2(toolsDistanceX, toolsDistanceY), "item:fishingNet", "playerAllegiance", null, delayForItemsAndAgents));
            list.Add(Scenarios.ScenarioLoader.SpawnItemAtStartLocation("startFishTrapBasket", new Vector2(toolsDistanceX, toolsDistanceY), "item:fishTrapBasket", "playerAllegiance", null, delayForItemsAndAgents)); 
            list.Add(Scenarios.ScenarioLoader.SpawnItemAtStartLocation("startFishTrapHoopNet", new Vector2(toolsDistanceX, toolsDistanceY), "item:fishTrapHoopNet", "playerAllegiance", null, delayForItemsAndAgents)); 
          ...
          //mostly for testing://
            ...
            list.Add(Scenarios.ScenarioLoader.SpawnItemAtStartLocation("startImprovisedGreenHouseCover", new Vector2(testDistanceX, testDistanceY), "item:improvisedGreenHouseCover", "playerAllegiance", null, delayForItemsAndAgents, amount: 4));
          ...
          list.Add(new SpawnEntityAction()
          {
            ...
            list.Add(new SetPropertyAction()
            {
                KeyName = "setStartingLocationSouthBank", //was "setStartingLocationRiverBank"

                PropertyKey = "startingLocation",
                Value = new ValueNode()
                {
                    Location = new Microsoft.Xna.Framework.Vector2(2596f, 2461f) //
                }
            ...
            list.Add(new SetPropertyAction()
            {
                ...
                Value = new ValueNode()
                {
                    Location = new Microsoft.Xna.Framework.Vector2(1310f, 1730f) // 
                }
            ...
            list.Add(new SetPropertyAction()
            {
                KeyName = "setStartingLocationCenterMudBank", //was "setStartingLocationNorthMuddyCreek"

                PropertyKey = "startingLocation",
                Value = new ValueNode()
                {
                    Location = new Microsoft.Xna.Framework.Vector2(2100f, 1280f) // was 2326, 1314
                }
            ...
            list.Add(new ExploreAction()
            {
                ...
                DetectMode = InGameEvents.Actions.DetectMode.DetectAlwaysSeenEntities,
                //PerformDetection = true,
                OffsetLocationEnd = new Microsoft.Xna.Framework.Vector2(3500f, 3076f),
                EntityToExploreWith = new InGameEvents.PropertyObjects.TargetObject()
                {
                    GetList = new InGameEvents.PropertyObjects.GetList()
                    {
...
*/
            ...
            list.Add(new SpawnAllegianceAction()
            {
                ...
                ExpeditionData = new ExpeditionData()
                {
                    ...
                    Location = new ValueNode()
                    {
                        Location = new Vector2(3120, 2496)
                    },
            ...
            list.Add(new SpawnAllegianceAction()
            {
                ...
                ExpeditionData = new ExpeditionData()
                {
                    ...
                    Location = new ValueNode()
                        {
                            Location = new Vector2(1680, 2064)//(2016, 2496) //4384, 2189 // 3072, 1488 //
                        },
                    PopulationData = new PopulationData()
                    {
                        MaxMembers = 4,
            ...
            list.Add(new SpawnAllegianceAction()
            {
                ...
                ExpeditionData = new ExpeditionData()
                {
                    ...
                    Location = new ValueNode()
                    {
                        Location = new Vector2(1680, 2064)//(1536, 1104) //4900,4900
                    },
                    PopulationData = new PopulationData()
                    {
                        MaxMembers = 4,
            ...
            list.Add(new SpawnAllegianceAction()
            {
                ...
                ExpeditionData = new ExpeditionData()
                {
                    ...
                    Location = new ValueNode()
                    {
                        Location = new Vector2(3312, 3168)
                    },
                    PopulationData = new PopulationData()
                    {
                        SpawnRadius = 150f,
            ...
            list.Add(new SpawnAllegianceAction()
            {
                ...
                ExpeditionData = new ExpeditionData()
                {
                    ...
                    Location = new ValueNode()
                    {
                        Location = new Vector2(3024, 1008)
                    },
                    PopulationData = new PopulationData()
                    {
                        MaxMembers = 1,
            ...
            list.Add(new SpawnAllegianceAction()
            {
                ...
                ExpeditionData = new ExpeditionData()
                {
                    ...
                    Location = new ValueNode()
                    {
                        Location = new Vector2(3072, 3690)
                    },
                    PopulationData = new PopulationData()
                    {
                        MaxMembers = 1,
            ...
            list.Add(new SpawnAllegianceAction()
            {
                ...
                ExpeditionData = new ExpeditionData()
                {
                    ...
                    Location = new ValueNode()
                    {
                        Location = new Vector2(1824, 2592)// was 2112, 1248
                    },
                    PopulationData = new PopulationData()
                    {
            ...
            #region leafcutter expedition #3 
            ...
            list.Add(new SpawnAllegianceAction()
            {
                ...
                ExpeditionData = new ExpeditionData()
                {
                    ...
                    Location = new ValueNode()
                    {
                        Location = new Vector2(2112, 2256)// was 3600. 1248
                    },
                    PopulationData = new PopulationData()
                    {
            ...
            #region clay, bog fishweir/traps and farms
            ...
            list.Add(new SpawnEntityAction()
            {
                ...
                EntityData = new EntityData()
                {
                    ...
                    Name = "Small plot 1",
                    Location = new Vector3(2024f, 2326f, 0)
                },
            ...
            list.Add(new SpawnEntityAction()
            {
                ...
                EntityData = new EntityData()
                {
                    EntityKey = "terrain:smallPlotSpot",
                    Name = "Small plot 2",
                    Location = new Vector3(2225f, 2359f, 0)
                },
            ...
            list.Add(new SpawnEntityAction()
            {
                ...
                EntityData = new EntityData()
                {
                    EntityKey = "terrain:smallPlotSpot",
                    Name = "Small plot 3",
                    Location = new Vector3(2058f, 2466f, 0)
                },
            ...
            list.Add(new SpawnEntityAction()
            {
                ...
                EntityData = new EntityData()
                {
                    EntityKey = "terrain:smallPlotSpot",
                    Name = "Small plot 4",
                    Location = new Vector3(1081f, 1748f, 0)
                },
            ...
            list.Add(new SpawnEntityAction()
            {
                ...
                EntityData = new EntityData()
                {
                    EntityKey = "terrain:smallPlotSpot",
                    Name = "Small plot 5",
                    Location = new Vector3(727f, 1921f, 0)
                },
            ...
            list.Add(new SpawnEntityAction()
            {
                ...
                EntityData = new EntityData()
                {
                    EntityKey = "terrain:smallPlotSpot",
                    Name = "Small plot 6",
                    Location = new Vector3(949f, 1608f, 0)
                },
            ...
            list.Add(new SpawnEntityAction()
            {
                ...
                EntityData = new EntityData()
                {
                    EntityKey = "terrain:smallPlotSpot",
                    Name = "Small plot 7",
                    Location = new Vector3(2282f, 1165f, 0)
                },
            ...
            list.Add(new SpawnEntityAction()
            {
                ...
                EntityData = new EntityData()
                {
                    ...
                    Name = "Large plot 1",
                    Location = new Vector3(1050f, 1986f, 0)
                },
            ...
            list.Add(new SpawnEntityAction()
            {
                ...
                EntityData = new EntityData()
                {
                    EntityKey = "terrain:largePlotSpot",
                    Name = "Large plot 2",
                    Location = new Vector3(834f, 1766f, 0)
                },
            ...
            list.Add(new SpawnEntityAction()
            {
                ...
                EntityData = new EntityData()
                {
                    EntityKey = "terrain:largePlotSpot",
                    Name = "Large plot 3",
                    Location = new Vector3(1775f, 2388f, 0)
                },
            ...
            list.Add(new SpawnEntityAction() 
            {
                ...
                EntityData = new EntityData()
                {
                    ...
                    Name = "Pier spot",
                    Location = new Vector3(1586f, 1832f, 0)
                },
            ...
            list.Add(new SpawnEntityAction()
            {
                ...
                EntityData = new EntityData()
                {
                    EntityKey = "terrain:pierSpot",
                    Name = "Pier spot",
                    Location = new Vector3(2762f, 2622f, 0)
                },

            });
            #endregion
            #region #3 huntingland
            list.Add(new SpawnEntityAction() //north east
            {
                ...
                EntityData = new EntityData()
                {
                    EntityKey = "terrain:pierSpot",
                    Name = "Pier spot",
                    Location = new Vector3(2274f, 1432f, 0) //was 3330f, 650f, 0  but too far away for bugfree hauling
                },
            ...
            list.Add(new SpawnEntityAction()
            {
                ...
                EntityData = new EntityData()
                {
                    ...
                    Location = new Vector3(504f, 588f, 0)
                },
            ...
            list.Add(new SpawnEntityAction()
            {
                ...
                EntityData = new EntityData()
                {
                    ...
                    Location = new Vector3(1660f, 1702f, 0) //was inland: 3792f, 2736f,
                },
            ...
            list.Add(new SpawnEntityAction()
            {
                ...
                EntityData = new EntityData()
                {
                    ...
                    Location = new Vector3(1090f, 2700f, 0) //was inland: 3792f, 2736f,
                },
            ...
            list.Add(new SpawnEntityAction()
            {
                ...
                EntityData = new EntityData()
                {
                    ...
                    Location = new Vector3(2380f, 3200f, 0) //was inland: 3792f, 2736f,
                },
            ...
            list.Add(new SpawnEntityAction()
            {
                ...
                EntityData = new EntityData()
                {
                    ...
                    Location = new Vector3(920f, 1256f, 0)
                },
            ...
            list.Add(new SpawnEntityAction()
            {
                ...
                EntityData = new EntityData()
                {
                    EntityKey = "terrain:fishTrapSpotShore",
                    Name = "Fish trap spot Freshwater",
                    Location = new Vector3(1110f, 852f, 0)
                },
            ...
            list.Add(new SpawnEntityAction()
            {
                ...
                EntityData = new EntityData()
                {
                    EntityKey = "terrain:fishTrapSpotShore",
                    Name = "Fish trap spot Freshwater",
                    Location = new Vector3(1808f, 1586f, 0)
                },

            });

            #endregion
            #region #4 center east
            list.Add(new SpawnEntityAction()
            {
                ...
                EntityData = new EntityData()
                {
                    EntityKey = "terrain:fishTrapSpotShore",
                    Name = "Fish trap spot Freshwater",
                    Location = new Vector3(2422f, 1592f, 0)
                },

            });
            #endregion
            #region #5 center east(more than #4)
            list.Add(new SpawnEntityAction()
            {
                ...
                EntityData = new EntityData()
                {
                    EntityKey = "terrain:fishTrapSpotShore",
                    Name = "Fish trap spot Freshwater",
                    Location = new Vector3(2716f, 2006f, 0)
                },
            ...
            list.Add(new SpawnEntityAction()
            {
                ...
                EntityData = new EntityData()
                {
                    EntityKey = "terrain:fishTrapSpotShore",
                    Name = "Fish trap spot Freshwater",
                    Location = new Vector3(2616f, 2728f, 0) //was (1840f, 2036f, 0) but blocked
                },
            ...
            list.Add(new SpawnEntityAction()
            {
                ...
                EntityData = new EntityData()
                {
                    EntityKey = "terrain:fishTrapSpotShore",
                    Name = "Fish trap spot Freshwater",
                    Location = new Vector3(2952f, 2936f, 0)
                },

            });
            #endregion
            #region #8 center east near border
            list.Add(new SpawnEntityAction()
            {
                ...
                EntityData = new EntityData()
                {
                    EntityKey = "terrain:fishTrapSpotShore",
                    Name = "Fish trap spot Freshwater",
                    Location = new Vector3(3496f, 2088f, 0) //was (2089f, 2457f, 0) but moved because blocked
                },

            });
            #endregion
            #region #9 southeast near border
            list.Add(new SpawnEntityAction()
            {
                ...
                EntityData = new EntityData()
                {
                    EntityKey = "terrain:fishTrapSpotShore",
                    Name = "Fish trap spot Freshwater",
                    Location = new Vector3(3425f, 2594f, 0) //was (3580f, 3130f, 0) but moved it. close to being blocked.
                },
            ...
            list.Add(new SpawnEntityAction()
            {
                ...
                EntityData = new EntityData()
                {
                    ...
                    Location = new Vector3(1768f, 3516f, 0) // south east corner 
                },
            ...
            list.Add(new SpawnEntityAction()
            {
                ...
                EntityData = new EntityData()
                {
                    ...
                    Name = "Peat deposit",
                    Location = new Vector3(2044f, 2688f, 0) //
                },

             });
            #endregion
            #region peat deposit northwest
            list.Add(new SpawnEntityAction()
            {
                ...
                EntityData = new EntityData()
                {
                    EntityKey = "terrain:peatDeposit",
                    Name = "Peat deposit",
                    Location = new Vector3(520f, 1808f, 0) //
                },
            ...
            #region salt deposit northwest cornor
            list.Add(new SpawnEntityAction()
            {
                ...
                EntityData = new EntityData()
                {
                    ...
                    Name = "Salt deposit",
                    Location = new Vector3(440f, 280f, 0) 
                },

            });
            #endregion

            #region clay deposit northeast
            list.Add(new SpawnEntityAction()
            {
                ...
                EntityData = new EntityData()
                {
                    ...
                    Name = "Clay deposit",
                    Location = new Vector3(1900f, 1280f, 0) 
                },

            });
            #endregion

            #region clay deposit not in use 
            list.Add(new SpawnEntityAction()
            {
            ...
            list.Add(
              new ParticleEffectAction()
              {
                  ...
                  Location = new ValueNode()
                  {
                      Location = new Microsoft.Xna.Framework.Vector2(1392f, 3000f)
            ...
            list.Add(
              new ParticleEffectAction()
              {
                  ...
                  Location = new ValueNode()
                  {
                      Location = new Microsoft.Xna.Framework.Vector2(1008f, 2670f)
            ...
            list.Add(
              new ParticleEffectAction()
              {
                  ...
                  Location = new ValueNode()
                  {
                      Location = new Microsoft.Xna.Framework.Vector2(1828f, 2022f)
            ...
            list.Add(
              new ParticleEffectAction()
              {
                  ...
                  Location = new ValueNode()
                  {
                      Location = new Microsoft.Xna.Framework.Vector2(2372f, 1738f)
                      //                Location = Maps.MapManager.TileToWorldPosVector2(new Point(19, 46))
                  },
                  ParticleEmitters = new[] { new ParticleEmitterEffect() { ParticleSystemKey = "smallFog" } }
            ...
            list.Add(
              new ParticleEffectAction()
              {
                  ...
                  Location = new ValueNode()
                  {
                      Location = new Microsoft.Xna.Framework.Vector2(2688f, 1872f)
            ...
            list.Add(
              new ParticleEffectAction()
              {
                  ...
                  Location = new ValueNode()
                  {
                      Location = new Microsoft.Xna.Framework.Vector2(922f, 1310f)
            ...
            list.Add(
              new ParticleEffectAction()
              {
                  ...
                  Location = new ValueNode()
                  {
                      Location = new Microsoft.Xna.Framework.Vector2(1152f, 624f)
            ...
            list.Add(
              new ParticleEffectAction()
              {
                  ...
                  Location = new ValueNode()
                  {
                      Location = Maps.MapManager.TileToWorldPosVector2(new Point(57, 64))
            ...
            list.Add(
              new ParticleEffectAction()
              {
                  ...
                  Location = new ValueNode()
                  {
                      Location = Maps.MapManager.TileToWorldPosVector2(new Point(61, 69))
            ...
            list.Add(
              new ParticleEffectAction()
              {
                  ...
                  Location = new ValueNode()
                  {
                      Location = Maps.MapManager.TileToWorldPosVector2(new Point(65, 67))
            ...
            list.Add(
             new ParticleEffectAction()
             {
                 ...
                 Location = new ValueNode()
                 {
                     Location = Maps.MapManager.TileToWorldPosVector2(new Point(73, 58))
            ...
            list.Add(
              new ParticleEffectAction()
              {
                  ...
                  Location = new ValueNode()
                  {
                      Location = Maps.MapManager.TileToWorldPosVector2(new Point(68, 70))
            ...
            list.Add(
              new ParticleEffectAction()
              {
                  ...
                  Location = new ValueNode()
                  {
                      Location = Maps.MapManager.TileToWorldPosVector2(new Point(74, 75))
            ...
            list.Add(
              new ParticleEffectAction()
              {
                  ...
                  Location = new ValueNode()
                  {
                      Location = Maps.MapManager.TileToWorldPosVector2(new Point(73, 56))
            ...
            list.Add(
                    new ParticleEffectAction()
                    {
                        ...
                        Location = new ValueNode()
                        {
                            Location = new Microsoft.Xna.Framework.Vector2(288f, 2900f)
            ...
            list.Add(
                    new ParticleEffectAction()
                    {
                        ...
                        Location = new ValueNode()
                        {
                            Location = new Microsoft.Xna.Framework.Vector2(768f, 3312f)
            ...
            list.Add(
                      new ParticleEffectAction()
                      {
                          ...
                          Location = new ValueNode()
                          {
                              Location = new Microsoft.Xna.Framework.Vector2(288f, 2928f)
            ...
            list.Add(
                      new ParticleEffectAction()
                      {
                          ...
                          Location = new ValueNode()
                          {
                              Location = new Microsoft.Xna.Framework.Vector2(720f, 3312f)
