...
namespace UWGame.SimSide.AllGameData.Scenarios.Scenario_4y // I chose a generic name so scenario name changes don't affect us so much...
{
    /// <summary>
    /// 
    ...
    /// </summary>
    public class Scenario4yLoader : ScenarioLoader // I chose a generic name so scenario name changes don't affect us so much...
    {
        ...
        {
            get { return "Fields of Tau Ceti - Alluvial Plain"; }
        }
        ...
        protected override Scenario InitScenarioHeader()
        {
            ...
            scenario = new Scenario()
            {
                ...
                MapSize = SimSide.Scenarios.MapSize.Medium,
                Allow32Bit = true,
        ...
        {
            DataLoader dataLoader = new Scenario4yDataLoader();
        ...
        protected override ScenarioData InitScenarioData()
        {
            ...
            //this is a smaller version of the Fields map. the map edge stops at around 3800, 3800  or 79,79 (included)
            ...
            #region music and game over
                  ...
                  #region animal spawns (migrations)                   
...
#if DEBUG || PROFILE
"startSentry","startSentry","startSentry","startSentryAmmo","startSentryAmmo",
//"startDiamondGlass","startshadeleafCanesTest","startImprovisedGreenHouseCover",
...
//"startBlackpulp","startBlackpulp","startBlackpulp","startBlackpulp",
  //"startHoe", "startHoe", "startGlassyCreeper", "startGlassyCreeper", "startCrystalBerries", "startCrystalBerries","startSteelSpade",
     /*        
             //           
              // 
              "startFishTrapBasket",
...
//-------------------------------------------------!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!--------------------------------------------
                  ...
                  #region animal expeditions
                        ...
                        "spawnLeafcutterExpedition#1", "spawnLeafcutterExpedition#3",
...
#region Spawn otherSite2 (random)                
                  ...
                  #region pier spots
                        "startPierSpot1",//emerald river, farmers
                        "startPierSpot2", // sourth east fishers
                        "startPierSpot3", //north east hunters
                  #endregion

                  #region particle effects                  
                        "smallFog1", "smallFog2", "smallFog3","smallFog4", "smallFog5","smallFog6","smallFog7",
                        "sulphurousSmoke1", "sulphurousSmoke2",
                        "haze1","haze2",
                         "fog1", "fog2","fog3", "fog4","fog5", "fog6","fog7", 
                              ...
                              new Option()
                                    {
                                      ...
                                      ConditionalEvents = new[]{"introDialogueVersatile", "introDialogueScreen"}, //INTRO DIALOGUE AND SCREEN
                                       ...
                                       {                                             
                                           //STARTING LOCATION:
                                           "setStartingLocationWestArableLand", "exploreShroudFromSouth",  
                         ...
                         "startGlassyCreeper", "startGlassyCreeper", "startGlassyCreeper", "startGlassyCreeper",
                                    ...
                                    new Option()
                                    {
                                      ...
                                      Difficulty = new CustomDifficulty()
                                      {
                                       ...
                                       ConditionalEvents = new[]{"introDialogueHuntingChickens", "introDialogueScreen"}, //INTRO DIALOGUE different from the turnip hunters, is about chickens
                                       ActionKeys = new[]
                                       {  //STARTING LOCATION:
                                           "setStartingLocationCenterMudBank", "exploreShroudFromSouth",
                                        ...
                                        //hunting weapons for hunting thunder chicken
                                            "startBlunderbuss", "startBlunderbuss","startBlackPowderShotAmmo","startBlackPowderShotAmmo","startBlackPowderShotAmmo",
                                            "startSpikeTrap", "startSpikeTrap",  "startSpikeTrap", "startSpikeTrap", 
                                    //Cooking/food:
                                           "startCookingPot", //
                                           "startJerky","startJerky","startJerky","startJerky", "startJerky","startJerky","startJerky",
                                      "startHardtack","startHardtack", "startHardtack","startHardtack","startHardtack","startHardtack", "startHardtack", "startHardtack",
                                   ...
                                   new Option()
                                    {
                                      ...
                                      ConditionalEvents = new[]{"introDialogueFishing", "introDialogueScreen"}, //INTRO DIALOGUE AND SCREEN
                                       ActionKeys = new[]
                                       {  //STARTING LOCATION:
                                           "setStartingLocationSouthBank", "exploreShroudFromSouth", //

                                           //natural terminal to wilderness
                                            "startNaturalTerminalGenericPosition",  //different because of geography?  "startNaturalTerminalFishingPosition",

                                        //PEOPLE: //2 persons are mentioned in story
                                       "spawnCastor", "spawnLinsey", "spawnHuntingSpecialist1", "spawnBushcraftSpecialist1", "spawnSecuritySpecialist1","spawnCookingSpecialist2", "spawnHaulRobot", //dog excluded because it runs too far from camp, also megapods nearby:"spawnDog",
                                          ...
                                          "startRadioAntenna", "startRadio",
                                           ...
                                           "startGunpowderRifle","startGunpowderAmmo","startGunpowderAmmo", "startImprovisedBow", "startIronArrow",
                                            ...
                                            "startPickaxe", //MP i'm only giving them a pickaxe to dig resource pits (NOT peat bank) and favorbread but prevent the fishers from starting the farm plot (requires spade/hoe) before they've traded. they have a lot of fish.
                                       //   "startSteelSpade",

                                    //Cooking/food:
                                           "startImprovisedCookingPot", //
                                            "startJerky","startJerky","startJerky", "startJerky", "startJerky","startJerky","startJerky", 
                                      "startHardtack","startHardtack", "startHardtack","startHardtack","startHardtack","startHardtack", "startHardtack", "startHardtack",      
                                    ...
                                    { //mp no longer a throng
                                      ...
                                      ConditionalEvents = new[]{"introDialogueThrong", "introDialogueScreen"}, //INTRO DIALOGUE AND SCREEN
                                       ...
                                       { //STARTING LOCATION:
                                        ...
                                        //PEOPLE: //2 persons are mentioned in story
                                       "spawnCastor", "spawnLinsey", 
                                       //these all have survivaltier (1) personality:  
                                       "spawnHuntingSpecialist1", "spawnBushcraftSpecialist1", "spawnMenialSpecialist1","spawnSecuritySpecialist1",
                                       "spawnDog",
                        ...
                        { 
                            new Option()
                            {
                                ...
                                { 
                                     ...
                                     "startFishTrapShore5", "startFishTrapShore6", "startFishTrapShore7", "startFishTrapShore8", "startFishTrapShore9",
                                    
                                
                                     "startBogOreDeposit1",
                                     "startPeatDeposit1","startPeatDeposit2",
                                     "startSaltDeposit1", 
                                     "startClayDeposit1",
