...
{
    /// <summary>
    /// Implementation of the Gauss Kruger formula for converting between geodetic coordinates and grid coordinates.
    /// </summary>
    public static class GaussKruger
    {
        ...
        {
            GridCoordinate gridCoordinate = new GridCoordinate { Projection = projection };
        ...
        public static GeodeticCoordinate GridToGeodetic(GridCoordinate coordinate)
        {
            ...
            GeodeticCoordinate geoCoord = new GeodeticCoordinate(radLon.ToDegrees(), radLat.ToDegrees());
