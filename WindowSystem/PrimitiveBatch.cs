...
namespace WindowSystem
{
    ...
    public class PrimitiveBatch : IDisposable   
    {
        ...
        int[] indexData = new int[DefaultBufferSize];
       ...
       // VertexDeclaration vertexDeclaration; // XNA 3
        ...
        public PrimitiveBatch(int drawAreaWidth, int drawAreaHeight, GraphicsDevice graphicsDevice, int? renderTargetWidth = null, int? renderTargetHeight = null)
        {
            ...
            /*vertexDeclaration = new VertexDeclaration(graphicsDevice, // XNA 3
            ...
            int width = renderTargetWidth ?? drawAreaWidth; // graphicsDevice.Viewport.Width;
            int height = renderTargetHeight ?? drawAreaHeight; // graphicsDevice.Viewport.Height;
            ...
            this.Projection = basicEffect.Projection;
        ...
        public void Begin(PrimitiveType primitiveType)
        {
           ...
           // basicEffect.Begin();
            basicEffect.CurrentTechnique.Passes[0].Apply(); // .Begin();
        ...
        private void Flush()
        {
            ...
            if (primitiveType == PrimitiveType.LineStrip)
            {
                ...
                if (primitiveCount > 0)
                {
                    ...
                    device.DrawUserIndexedPrimitives<VertexPositionColor>(primitiveType, vertices, 0, primitiveCount + 1, indexData, 0,
                        primitiveCount);
                }
            }
            else
        ...
        static private int NumVertsPerPrimitive(PrimitiveType primitive)
        {
            ...
            switch (primitive)
            {
               /* case PrimitiveType.PointList: // xna 3
